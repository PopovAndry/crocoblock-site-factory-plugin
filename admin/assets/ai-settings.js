	...
	function render() {
		...
		root.innerHTML = [
			'<header class="factory-ai-header">',
				'<div>',
					'<h1>AI Settings</h1>',
					'<p>Configure a safe foundation for future AI-assisted generation. This beta does not use AI to apply the deterministic Real Estate preset yet.</p>',
				'</div>',
			...
			'<section class="factory-ai-card">',
				...
				'</label>',
				'<p class="factory-ai-help">The full key is never returned to the browser after save. Constants and environment variables take priority over saved keys.</p>',
				renderModelSelector(),
			...
			'<section class="factory-ai-card">',
				...
				'<p>This estimate is local and approximate. It does not call OpenAI and does not calculate billing.</p>',
			...
			'<section class="factory-ai-card factory-ai-card-muted">',
				'<h2>Not enabled in v1</h2>',
				'<ul>',
					'<li>No prompt-to-blueprint generation.</li>',
					'<li>No AI JSON patches or auto-apply behavior.</li>',
					'<li>No image generation, streaming, connection test, background jobs, or billing enforcement.</li>',
				'</ul>',
			'</section>',
		].join( '' );
